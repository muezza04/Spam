...
import BeliPremium from "./BeliPremium";
        ...
        >
          ...
          <div className=" ">
            <div className=" row kategori-header d-flex gap-4">
              ...
              <button className="btn-kategori-header-2 col btn btn-light rounded-4 text-secondary active" onClick={() => navigate("/pilih-premium")}>
                Kelas Premium
              </button>
              <button className="btn-kategori-header-3 col btn btn-light rounded-4 text-secondary" onClick={() => navigate("/pilih-gratis")}>
                Kelas Gratis
              </button>
            </div>
