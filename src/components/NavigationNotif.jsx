            ...
            <ul class="navbar-nav mt-2 ">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="#">
                    <i className="bi bi-bell" style={{ width:"100px", height:"28px", color: "white", backgroundColor: "#489CFF", borderRadius: "10px",padding:"5px 25px", fontSize:"16px"}}> 
                    <span style={{ fontStyle: "normal", paddingLeft:"10px", fontWeight:"500"}}>Notifikasi</span></i>
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="/akunprofil"><i className="bi bi-person" style={{ color:"white" }}></i></a>
                </li>
              </ul>
          </div>
        </div>
